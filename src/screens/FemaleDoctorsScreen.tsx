...
type Props = NativeStackScreenProps<RootStackParamList, "FemaleDoctors">;
...
const FemaleDoctorsScreen: React.FC<Props> = ({ navigation }) => {
  const [sortBy, setSortBy] = useState("Female");
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Female</Text>
...
export default FemaleDoctorsScreen;
